...
#' @param export If `NULL` (default), the object will not be exported. Otherwise, provide a string
#' with the path and the name of the file where the object will be saved.
